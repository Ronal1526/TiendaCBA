        ...
        LazyVerticalGrid(
            ...
            items(
                listaInformacion
                    ...
                    item ->  CardInformacion(imagen = item.imagen, Titulo = item.Titulo, Contenido = item.Contenido, tituloDialogo = item.Titulo2, textoDialogo = item.Contenido2, imagenModal = item.imagen2 )
            }
        }
    }
}
...
private val listaInformacion = listOf(
    dataInformacion(R.drawable.informacion_2, R.string.manual_del_cliente, R.string.texto_sena, "Manual del cliente", "El Servicio Nacional de Aprendizaje, más conocido como SENA, es una entidad pública en Colombia que se encarga de la formación técnica, tecnológica y profesional de los ciudadanos", R.drawable.carrusel_1 ),
    dataInformacion(R.drawable.informacion_1, R.string.recompensas, R.string.nuestra_tienda, "Recompensas", "¡Gran noticia! ¡Tenemos un descuento especial para ti en nuestra tienda virtual! Por tiempo limitado, te ofrecemos un increíble descuento del 20% en todos nuestros productos.", R.drawable.vermas_1),
)
